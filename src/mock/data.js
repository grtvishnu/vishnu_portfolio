...
export const aboutData = {
  img: 'profile.jpg',
  paragraphOne:
    'I am a Computer Science Engineering graduate, with interests in data analytics, data science, and database management. I love the challenge of coding and I am passionate about making data-driven decisions! ',
  paragraphTwo:
    'I found that my favorite projects were ones where I got to deep dive into data analysis and create visualizations. I was interested in pursuing a technical position where I could develop models,learn new technologies/coding languages, and/or utilize statistics. ',
  paragraphThree:
    'I chose to enroll in an intensive Data Science course through Thinkful in order to solidify my technical skills and practice implementing machine learning models through project work.',
...
export const projectsData = [
  {
    ...
    info:
      'With any dataset it can analyze the data using multiple methods finding its data distibution using plots find diffrent type of correlations and covariance. it can find all summary of the dataset and it is used for supervised machine learning.',
    info2:
      'It can use for supervised classification methods like Logistic regression, Random forest, XGboost, Neural network with default parameters.',
  ...
  },
  {
    ...
    info:
      'Predicting Air Quality can help governments warn people at high risk. In this work feature importance of air pollution, Implementing Random forest, XGBoost, CatBoost and Deep learning machine learning (ML) approaches. We use 8 features, including meteorological data, ground-measured PM 2.5 and gaseous pollutants.',
    info2:
      'Forecasting Air quality using deep learning technique LSTM and Prophet package by Facebook we can extract the trend yearly seasonality, and weekly seasonality of the time series',
